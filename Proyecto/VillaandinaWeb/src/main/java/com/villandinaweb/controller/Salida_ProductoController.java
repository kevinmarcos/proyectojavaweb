...
public class Salida_ProductoController {
    ...
    @DeleteMapping
    public Salida_ProductoEntity delete(@PathVariable Long id, @RequestBody Salida_ProductoEntity e){
        Salida_ProductoEntity objcategoria = new Salida_ProductoEntity();
